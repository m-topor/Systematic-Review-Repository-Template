...
PROSPERO, OSF, AsPredicted etc. 
#### Published paper: 
Give a citation to the final published paper when available. If you submitted a registered report, you should link both the Stage 1 and the Stage 2 manuscript. 
#### DOI to this repository: 
[follow the instructions here](https://docs.github.com/en/repositories/archiving-a-github-repository/referencing-and-citing-content#issuing-a-persistent-identifier-for-your-repository-with-zenodo) 
